...
public:
    ...
    {
        std::unique_ptr<rpc::custom_action::ActionToExecute> rpc_obj(new rpc::custom_action::ActionToExecute());
    ...
    grpc::Status SubscribeCustomAction(grpc::ServerContext* /* context */, const mavsdk::rpc::custom_action::SubscribeCustomActionRequest* /* request */, grpc::ServerWriter<rpc::custom_action::CustomActionResponse>* writer) override
    {
        ...
        _custom_action.subscribe_custom_action(
            [this, &writer, &stream_closed_promise, is_finished, &subscribe_mutex](mavsdk::CustomAction::Result result,const mavsdk::CustomAction::ActionToExecute custom_action) {
