...
ComponentInformationServer::ComponentInformationServer(System& system) : PluginBase(), _impl{std::make_unique<ComponentInformationServerImpl>(system)} {}

ComponentInformationServer::ComponentInformationServer(std::shared_ptr<System> system) : PluginBase(), _impl{std::make_unique<ComponentInformationServerImpl>(system)} {}
