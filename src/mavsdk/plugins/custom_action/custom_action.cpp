...
CustomAction::CustomAction(System& system) : PluginBase(), _impl{std::make_unique<CustomActionImpl>(system)} {}

CustomAction::CustomAction(std::shared_ptr<System> system) : PluginBase(), _impl{std::make_unique<CustomActionImpl>(system)} {}

CustomAction::~CustomAction() {}



void CustomAction::set_custom_action_async(ActionToExecute action_to_execute, const ResultCallback callback)
{
...
bool
CustomAction::custom_action_cancellation() const
{
...
void CustomAction::respond_custom_action_async(ActionToExecute action_to_execute, Result custom_action_result, const ResultCallback callback)
{
...
CustomAction::Result CustomAction::respond_custom_action(ActionToExecute action_to_execute, Result custom_action_result) const
{
...
void CustomAction::custom_action_metadata_async(ActionToExecute action_to_execute, std::string file_path, const CustomActionMetadataCallback callback)
{
...
std::pair<CustomAction::Result, CustomAction::ActionMetadata> CustomAction::custom_action_metadata(ActionToExecute action_to_execute, std::string file_path) const
{
...
void CustomAction::execute_custom_action_global_script_async(std::string global_script, const ResultCallback callback)
{
...
CustomAction::Result CustomAction::execute_custom_action_global_script(std::string global_script) const
{
...
std::ostream& operator<<(std::ostream& str, CustomAction::Parameter::ParameterType const& parameter_type)
{
...
std::ostream& operator<<(std::ostream& str, CustomAction::Stage::StateTransitionCondition const& state_transition_condition)
{
...
std::ostream& operator<<(std::ostream& str, CustomAction::ActionMetadata::ActionCompleteCondition const& action_complete_condition)
{
...
bool operator==(const CustomAction::ActionMetadata& lhs, const CustomAction::ActionMetadata& rhs)
{
    return
        (rhs.id == lhs.id) &&
        (rhs.action_name == lhs.action_name) &&
        (rhs.action_description == lhs.action_description) &&
        (rhs.global_script == lhs.global_script) &&
        ((std::isnan(rhs.global_timeout) && std::isnan(lhs.global_timeout)) || rhs.global_timeout == lhs.global_timeout) &&
