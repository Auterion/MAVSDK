...
public:
     ...
     */
    friend bool operator==(const CustomAction::ActionToExecute& lhs, const CustomAction::ActionToExecute& rhs);
     ...
     */
    friend std::ostream& operator<<(std::ostream& str, CustomAction::ActionToExecute const& action_to_execute);
     ...
     * @return A reference to the stream.
     */
    friend std::ostream& operator<<(std::ostream& str, CustomAction::Command::CommandType const& command_type);
        
        CommandType type{}; /**< @brief Type enum value. LONG or INT */
        uint32_t target_system_id{}; /**< @brief Target system ID */
        uint32_t target_component_id{}; /**< @brief Target component ID. Should match the MAV_COMP */
        uint32_t frame{}; /**< @brief The coordinate system of the COMMAND. Used in COMMAND_INT */
        uint32_t command{}; /**< @brief Command to send to target system and component. Should match the MAV_CMD */
        ...
        double param5{}; /**< @brief Command parameter 5. In COMMAND_INT: local x position or latitude. Casted to int32 before sending the command */
        double param6{}; /**< @brief Command parameter 6. In COMMAND_INT: local y position or longitude. Casted to int32 before sending the command */
        double param7{}; /**< @brief Command parameter 7. In COMMAND_INT: z position: global: altitude in meters (relative or absolute, depending on frame) */
        bool is_local{}; /**< @brief In COMMAND_INT: Set to true if x/y are local positions. Otherwise, these are lat/lon */
    };
     ...
     * @return A reference to the stream.
     */
    friend std::ostream& operator<<(std::ostream& str, CustomAction::Parameter::ParameterType const& parameter_type);
        
        ParameterType type{}; /**< @brief Type enum value. INT or FLOAT. */
        std::string name{}; /**< @brief Parameter name. */
        float value{}; /**< @brief Parameter value. Defaults to float, but can be truncated to an int. */
    };
    ...
    enum class StateTransitionCondition {
        OnResultSuccess, /**< @brief Transitions to the next stage case the script/command is successful.. */
        OnTimeout, /**< @brief Transitions to the next stage after a defined time.. */
        OnLandingComplete, /**< @brief Transitions to the next stage after the vehicle is landed.. */
        OnTakeoffComplete, /**< @brief Transitions to the next stage after the vehicle finishes takeoff.. */
        OnModeChange, /**< @brief Transitions to the next stage after the vehicle changes from one user-specified fligght mode to another.. */
        OnCustomConditionTrue, /**< @brief Transitions to the next stage after a user-specified condition is true.. */
        OnCustomConditionFalse, /**< @brief Transitions to the next stage after a user-specified condition is false.. */
    };

    /**
     * @brief Stream operator to print information about a `CustomAction::StateTransitionCondition`.
     *
     * @return A reference to the stream.
     */
    friend std::ostream& operator<<(std::ostream& str, CustomAction::Stage::StateTransitionCondition const& state_transition_condition);
        ...
        StateTransitionCondition state_transition_condition{}; /**< @brief State transition condition enum value. */
    ...
    enum class ActionCompleteCondition {
        ...
        OnCustomConditionTrue, /**< @brief Action is complete when user-specified condition is true.. */
        OnCustomConditionFalse, /**< @brief Action is complete whenr a user-specified condition is false.. */
    };

    /**
     * @brief Stream operator to print information about a `CustomAction::ActionCompleteCondition`.
     *
     * @return A reference to the stream.
     */
    friend std::ostream& operator<<(std::ostream& str, CustomAction::ActionMetadata::ActionCompleteCondition const& action_complete_condition);
        
        uint32_t id{}; /**< @brief ID of the action */
        std::string action_name{}; /**< @brief Name of the action */
        std::string action_description{}; /**< @brief Description of the action */
        std::string global_script{}; /**< @brief Script to run for this specific action. Runs instead of the stages. */
        double global_timeout{}; /**< @brief Timeout for the action in seconds. If a global script is set, it is used as a timeout for the script. Otherwise, for a staged action, defines the global timeout for the action. independently of the state of the stage processing. */
        ActionCompleteCondition action_complete_condition{}; /**< @brief Action complete condition enum value */
        std::vector<Stage> stages{}; /**< @brief Timestamped ordered stages. Runs instead of the global script. */
    };
     ...
     * @return `true` if items are equal.
     */
    friend bool operator==(const CustomAction::ActionMetadata& lhs, const CustomAction::ActionMetadata& rhs);
     ...
     * @return A reference to the stream.
     */
    friend std::ostream& operator<<(std::ostream& str, CustomAction::ActionMetadata const& action_metadata);
    ...
    */
     ...
     */
    void respond_custom_action_async(ActionToExecute action_to_execute, Result custom_action_result, const ResultCallback callback);
     ...
     * @brief Respond to the custom action command with progress.
     *
     * This function is blocking. See 'respond_custom_action_async' for the non-blocking counterpart.
     *
     * @return Result of request.
     */
    Result respond_custom_action(ActionToExecute action_to_execute, Result custom_action_result) const;
    ...
    */
     ...
     */
    void custom_action_metadata_async(ActionToExecute action_to_execute, std::string file_path, const CustomActionMetadataCallback callback);
     ...
     * @brief Request custom action metadata.
     *
     * This function is blocking. See 'custom_action_metadata_async' for the non-blocking counterpart.
     *
     * @return Result of request.
     */
    std::pair<Result, CustomAction::ActionMetadata> custom_action_metadata(ActionToExecute action_to_execute, std::string file_path) const;
     ...
     *
     * This function is non-blocking. See 'execute_custom_action_stage' for the blocking counterpart.
     */
     ...
     * @brief Execute custom action stage.
     *
     * This function is blocking. See 'execute_custom_action_stage_async' for the non-blocking counterpart.
     *
     * @return Result of request.
     */
     ...
     *
     * This function is non-blocking. See 'execute_custom_action_global_script' for the blocking counterpart.
     */
    void execute_custom_action_global_script_async(std::string global_script, const ResultCallback callback);
     ...
     * @brief Execute custom action global script.
     *
     * This function is blocking. See 'execute_custom_action_global_script_async' for the non-blocking counterpart.
     *
     * @return Result of request.
     */
