...
// (see https://github.com/mavlink/MAVSDK-Proto/blob/main/protos/obstacle_avoidance_server/obstacle_avoidance_server.proto)
...
public:
    ...
    enum class ControlType {
        ...
        Enable, /**< @brief Enable obstacle avoidance service. Used to switch the service from an idle state to an active state.. */
        Disable, /**< @brief Disable obstacle avoidance service. Used to switch the service from an active state to an idle state.. */
    };
     ...
     */
    friend std::ostream& operator<<(std::ostream& str, ObstacleAvoidanceServer::Control::ControlType const& control_type);
     ...
     */
    friend bool operator==(const ObstacleAvoidanceServer::Control& lhs, const ObstacleAvoidanceServer::Control& rhs);
     ...
     * @return A reference to the stream.
     */
    friend std::ostream& operator<<(std::ostream& str, ObstacleAvoidanceServer::Control const& control);
