...
ObstacleAvoidanceServer::ObstacleAvoidanceServer(System& system) : PluginBase(), _impl{std::make_unique<ObstacleAvoidanceServerImpl>(system)} {}

ObstacleAvoidanceServer::ObstacleAvoidanceServer(std::shared_ptr<System> system) : PluginBase(), _impl{std::make_unique<ObstacleAvoidanceServerImpl>(system)} {}
...
ObstacleAvoidanceServer::Control
ObstacleAvoidanceServer::control() const
{
...
std::ostream& operator<<(std::ostream& str, ObstacleAvoidanceServer::Control::ControlType const& control_type)
{
    switch (control_type) {
...
bool operator==(const ObstacleAvoidanceServer::Control& lhs, const ObstacleAvoidanceServer::Control& rhs)
{
    return
        (rhs.control_type == lhs.control_type);
}
