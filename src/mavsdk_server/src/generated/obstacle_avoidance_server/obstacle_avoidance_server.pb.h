...
enum Control_ControlType : int {
  ...
  Control_ControlType_Control_ControlType_INT_MIN_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::min(),
  Control_ControlType_Control_ControlType_INT_MAX_SENTINEL_DO_NOT_USE_ = std::numeric_limits<int32_t>::max()
};
...
class SubscribeControlRequest final :
    public ::PROTOBUF_NAMESPACE_ID::internal::ZeroFieldsBase /* @@protoc_insertion_point(class_definition:mavsdk.rpc.obstacle_avoidance_server.SubscribeControlRequest) */ {
 public:
...
class ControlResponse final :
 ...
 public:
  ...
  PROTOBUF_NODISCARD ::mavsdk::rpc::obstacle_avoidance_server::Control* release_control();
