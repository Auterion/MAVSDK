...
::PROTOBUF_NAMESPACE_ID::Metadata descriptor_table_obstacle_5favoidance_5fserver_2fobstacle_5favoidance_5fserver_2eproto_metadata_getter(int index);
namespace mavsdk {
namespace rpc {
...
class SubscribeControlRequest PROTOBUF_FINAL :
 ...
 public:
  ...
  static ::PROTOBUF_NAMESPACE_ID::Metadata GetMetadataStatic() {
    return ::descriptor_table_obstacle_5favoidance_5fserver_2fobstacle_5favoidance_5fserver_2eproto_metadata_getter(kIndexInFileMessages);
  }
