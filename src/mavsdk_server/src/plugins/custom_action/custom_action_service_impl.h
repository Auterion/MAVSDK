...
public:
    ...
    static rpc::custom_action::Command::Type translateToRpcType(const mavsdk::CustomAction::Command::Type& type)
    {
        switch (type) {
            default:
    ...
    static mavsdk::CustomAction::Command::Type translateFromRpcType(const rpc::custom_action::Command::Type type)
    {
        switch (type) {
            default:
                LogErr() << "Unknown type enum value: " << static_cast<int>(type);
        ...
        rpc::custom_action::SetCustomActionResponse* response) override
    {
        ...
        auto result = _custom_action.set_custom_action(translateFromRpcActionToExecute(request->action()));
    ...
    grpc::Status SubscribeCustomAction(grpc::ServerContext* /* context */, const mavsdk::rpc::custom_action::SubscribeCustomActionRequest* /* request */, grpc::ServerWriter<rpc::custom_action::CustomActionResponse>* writer) override
    {
        ...
        _custom_action.subscribe_custom_action(
            ...
            rpc_response.set_allocated_action(translateToRpcActionToExecute(custom_action).release());
        ...
        rpc::custom_action::RespondCustomActionResponse* response) override
    {
        ...
        auto result = _custom_action.respond_custom_action(translateFromRpcActionToExecute(request->action()), translateFromRpcCustomActionResult(request->result()));
        ...
        rpc::custom_action::CustomActionMetadataResponse* response) override
    {
        ...
        auto result = _custom_action.custom_action_metadata(translateFromRpcAction(request->action()), request->file_path());

        if (response != nullptr) {
            fillResponseWithResult(response, result.first);
            
            response->set_allocated_action_config(translateToRpcActionMetadata(result.second).release());
        ...
        rpc::custom_action::ExecuteCustomActionStageResponse* response) override
    {
        ...
        auto result = _custom_action.execute_custom_action_stage(translateFromRpcStage(request->stage()));
