...
// (see https://github.com/mavlink/MAVSDK-Proto/blob/master/protos/custom_action/custom_action.proto)
...
public:
    ...
    static std::unique_ptr<rpc::custom_action::ActionToExecute> translateToRpcActionToExecute(const mavsdk::CustomAction::ActionToExecute &action_to_execute)
    {
    ...
    static mavsdk::CustomAction::ActionToExecute translateFromRpcActionToExecute(const rpc::custom_action::ActionToExecute& action_to_execute)
    {
    ...
    static rpc::custom_action::Command::CommandType translateToRpcCommandType(const mavsdk::CustomAction::Command::CommandType& command_type)
    {
        switch (command_type) {
            default:
    ...
    static mavsdk::CustomAction::Command::CommandType translateFromRpcCommandType(const rpc::custom_action::Command::CommandType command_type)
    {
        switch (command_type) {
            default:
                LogErr() << "Unknown command_type enum value: " << static_cast<int>(command_type);
    ...
    static std::unique_ptr<rpc::custom_action::Command> translateToRpcCommand(const mavsdk::CustomAction::Command &command)
    {
    ...
    static mavsdk::CustomAction::Command translateFromRpcCommand(const rpc::custom_action::Command& command)
    {
    ...
    static rpc::custom_action::Parameter::ParameterType translateToRpcParameterType(const mavsdk::CustomAction::Parameter::ParameterType& parameter_type)
    {
        switch (parameter_type) {
            default:
                LogErr() << "Unknown parameter_type enum value: " << static_cast<int>(parameter_type);
            // FALLTHROUGH
    ...
    static mavsdk::CustomAction::Parameter::ParameterType translateFromRpcParameterType(const rpc::custom_action::Parameter::ParameterType parameter_type)
    {
        switch (parameter_type) {
            default:
                LogErr() << "Unknown parameter_type enum value: " << static_cast<int>(parameter_type);
    ...
    static std::unique_ptr<rpc::custom_action::Parameter> translateToRpcParameter(const mavsdk::CustomAction::Parameter &parameter)
    {
    ...
    static mavsdk::CustomAction::Parameter translateFromRpcParameter(const rpc::custom_action::Parameter& parameter)
    {
    ...
    static rpc::custom_action::Stage::StateTransitionCondition translateToRpcStateTransitionCondition(const mavsdk::CustomAction::Stage::StateTransitionCondition& state_transition_condition)
    {
        switch (state_transition_condition) {
            default:
                LogErr() << "Unknown state_transition_condition enum value: " << static_cast<int>(state_transition_condition);
            // FALLTHROUGH
            case mavsdk::CustomAction::Stage::StateTransitionCondition::OnResultSuccess:
                return rpc::custom_action::Stage_StateTransitionCondition_STATE_TRANSITION_CONDITION_ON_RESULT_SUCCESS;
            case mavsdk::CustomAction::Stage::StateTransitionCondition::OnTimeout:
                return rpc::custom_action::Stage_StateTransitionCondition_STATE_TRANSITION_CONDITION_ON_TIMEOUT;
            case mavsdk::CustomAction::Stage::StateTransitionCondition::OnLandingComplete:
                return rpc::custom_action::Stage_StateTransitionCondition_STATE_TRANSITION_CONDITION_ON_LANDING_COMPLETE;
            case mavsdk::CustomAction::Stage::StateTransitionCondition::OnTakeoffComplete:
                return rpc::custom_action::Stage_StateTransitionCondition_STATE_TRANSITION_CONDITION_ON_TAKEOFF_COMPLETE;
            case mavsdk::CustomAction::Stage::StateTransitionCondition::OnModeChange:
                return rpc::custom_action::Stage_StateTransitionCondition_STATE_TRANSITION_CONDITION_ON_MODE_CHANGE;
            case mavsdk::CustomAction::Stage::StateTransitionCondition::OnCustomConditionTrue:
                return rpc::custom_action::Stage_StateTransitionCondition_STATE_TRANSITION_CONDITION_ON_CUSTOM_CONDITION_TRUE;
            case mavsdk::CustomAction::Stage::StateTransitionCondition::OnCustomConditionFalse:
                return rpc::custom_action::Stage_StateTransitionCondition_STATE_TRANSITION_CONDITION_ON_CUSTOM_CONDITION_FALSE;
        }
    }

    static mavsdk::CustomAction::Stage::StateTransitionCondition translateFromRpcStateTransitionCondition(const rpc::custom_action::Stage::StateTransitionCondition state_transition_condition)
    {
        switch (state_transition_condition) {
            default:
                LogErr() << "Unknown state_transition_condition enum value: " << static_cast<int>(state_transition_condition);
            // FALLTHROUGH
            case rpc::custom_action::Stage_StateTransitionCondition_STATE_TRANSITION_CONDITION_ON_RESULT_SUCCESS:
                return mavsdk::CustomAction::Stage::StateTransitionCondition::OnResultSuccess;
            case rpc::custom_action::Stage_StateTransitionCondition_STATE_TRANSITION_CONDITION_ON_TIMEOUT:
                return mavsdk::CustomAction::Stage::StateTransitionCondition::OnTimeout;
            case rpc::custom_action::Stage_StateTransitionCondition_STATE_TRANSITION_CONDITION_ON_LANDING_COMPLETE:
                return mavsdk::CustomAction::Stage::StateTransitionCondition::OnLandingComplete;
            case rpc::custom_action::Stage_StateTransitionCondition_STATE_TRANSITION_CONDITION_ON_TAKEOFF_COMPLETE:
                return mavsdk::CustomAction::Stage::StateTransitionCondition::OnTakeoffComplete;
            case rpc::custom_action::Stage_StateTransitionCondition_STATE_TRANSITION_CONDITION_ON_MODE_CHANGE:
                return mavsdk::CustomAction::Stage::StateTransitionCondition::OnModeChange;
            case rpc::custom_action::Stage_StateTransitionCondition_STATE_TRANSITION_CONDITION_ON_CUSTOM_CONDITION_TRUE:
                return mavsdk::CustomAction::Stage::StateTransitionCondition::OnCustomConditionTrue;
            case rpc::custom_action::Stage_StateTransitionCondition_STATE_TRANSITION_CONDITION_ON_CUSTOM_CONDITION_FALSE:
                return mavsdk::CustomAction::Stage::StateTransitionCondition::OnCustomConditionFalse;
        }
    }


    static std::unique_ptr<rpc::custom_action::Stage> translateToRpcStage(const mavsdk::CustomAction::Stage &stage)
    {
        ...
        rpc_obj->set_allocated_parameter_set(translateToRpcParameter(stage.parameter_set).release());
                
            
        
            
                
        rpc_obj->set_state_transition_condition(translateToRpcStateTransitionCondition(stage.state_transition_condition));
    ...
    static mavsdk::CustomAction::Stage translateFromRpcStage(const rpc::custom_action::Stage& stage)
    {
        ...
        obj.state_transition_condition = translateFromRpcStateTransitionCondition(stage.state_transition_condition());
    ...
    static rpc::custom_action::ActionMetadata::ActionCompleteCondition translateToRpcActionCompleteCondition(const mavsdk::CustomAction::ActionMetadata::ActionCompleteCondition& action_complete_condition)
    {
        switch (action_complete_condition) {
            default:
                LogErr() << "Unknown action_complete_condition enum value: " << static_cast<int>(action_complete_condition);
            // FALLTHROUGH
            case mavsdk::CustomAction::ActionMetadata::ActionCompleteCondition::OnLastStageComplete:
                return rpc::custom_action::ActionMetadata_ActionCompleteCondition_ACTION_COMPLETE_CONDITION_ON_LAST_STAGE_COMPLETE;
            case mavsdk::CustomAction::ActionMetadata::ActionCompleteCondition::OnTimeout:
                return rpc::custom_action::ActionMetadata_ActionCompleteCondition_ACTION_COMPLETE_CONDITION_ON_TIMEOUT;
            case mavsdk::CustomAction::ActionMetadata::ActionCompleteCondition::OnResultSuccess:
                return rpc::custom_action::ActionMetadata_ActionCompleteCondition_ACTION_COMPLETE_CONDITION_ON_RESULT_SUCCESS;
            case mavsdk::CustomAction::ActionMetadata::ActionCompleteCondition::OnCustomConditionTrue:
                return rpc::custom_action::ActionMetadata_ActionCompleteCondition_ACTION_COMPLETE_CONDITION_ON_CUSTOM_CONDITION_TRUE;
            case mavsdk::CustomAction::ActionMetadata::ActionCompleteCondition::OnCustomConditionFalse:
                return rpc::custom_action::ActionMetadata_ActionCompleteCondition_ACTION_COMPLETE_CONDITION_ON_CUSTOM_CONDITION_FALSE;
        }
    }

    static mavsdk::CustomAction::ActionMetadata::ActionCompleteCondition translateFromRpcActionCompleteCondition(const rpc::custom_action::ActionMetadata::ActionCompleteCondition action_complete_condition)
    {
        switch (action_complete_condition) {
            default:
                LogErr() << "Unknown action_complete_condition enum value: " << static_cast<int>(action_complete_condition);
            // FALLTHROUGH
            case rpc::custom_action::ActionMetadata_ActionCompleteCondition_ACTION_COMPLETE_CONDITION_ON_LAST_STAGE_COMPLETE:
                return mavsdk::CustomAction::ActionMetadata::ActionCompleteCondition::OnLastStageComplete;
            case rpc::custom_action::ActionMetadata_ActionCompleteCondition_ACTION_COMPLETE_CONDITION_ON_TIMEOUT:
                return mavsdk::CustomAction::ActionMetadata::ActionCompleteCondition::OnTimeout;
            case rpc::custom_action::ActionMetadata_ActionCompleteCondition_ACTION_COMPLETE_CONDITION_ON_RESULT_SUCCESS:
                return mavsdk::CustomAction::ActionMetadata::ActionCompleteCondition::OnResultSuccess;
            case rpc::custom_action::ActionMetadata_ActionCompleteCondition_ACTION_COMPLETE_CONDITION_ON_CUSTOM_CONDITION_TRUE:
                return mavsdk::CustomAction::ActionMetadata::ActionCompleteCondition::OnCustomConditionTrue;
            case rpc::custom_action::ActionMetadata_ActionCompleteCondition_ACTION_COMPLETE_CONDITION_ON_CUSTOM_CONDITION_FALSE:
                return mavsdk::CustomAction::ActionMetadata::ActionCompleteCondition::OnCustomConditionFalse;
        }
    }


    static std::unique_ptr<rpc::custom_action::ActionMetadata> translateToRpcActionMetadata(const mavsdk::CustomAction::ActionMetadata &action_metadata)
    {
        ...
        rpc_obj->set_action_complete_condition(translateToRpcActionCompleteCondition(action_metadata.action_complete_condition));
    ...
    static mavsdk::CustomAction::ActionMetadata translateFromRpcActionMetadata(const rpc::custom_action::ActionMetadata& action_metadata)
    {
        ...
        obj.action_complete_condition = translateFromRpcActionCompleteCondition(action_metadata.action_complete_condition());
            
        
            
                for (const auto& elem : action_metadata.stages()) {
                    obj.stages.push_back(translateFromRpcStage(static_cast<mavsdk::rpc::custom_action::Stage>(elem)));
                }
    ...
    static rpc::custom_action::CustomActionResult::Result translateToRpcResult(const mavsdk::CustomAction::Result& result)
    {
        switch (result) {
            default:
    ...
    static mavsdk::CustomAction::Result translateFromRpcResult(const rpc::custom_action::CustomActionResult::Result result)
    {
        switch (result) {
            default:
                LogErr() << "Unknown result enum value: " << static_cast<int>(result);
        ...
        rpc::custom_action::SetCustomActionResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin()->set_custom_action(translateFromRpcActionToExecute(request->action_to_execute()));
    ...
    grpc::Status SubscribeCustomAction(grpc::ServerContext* /* context */, const mavsdk::rpc::custom_action::SubscribeCustomActionRequest* /* request */, grpc::ServerWriter<rpc::custom_action::CustomActionResponse>* writer) override
    {
        if (_lazy_plugin.maybe_plugin() == nullptr) {
        ...
        _lazy_plugin.maybe_plugin()->subscribe_custom_action(
            [this, &writer, &stream_closed_promise, is_finished, subscribe_mutex](const mavsdk::CustomAction::ActionToExecute custom_action) {

            rpc::custom_action::CustomActionResponse rpc_response;
        
            rpc_response.set_allocated_action_to_execute(translateToRpcActionToExecute(custom_action).release());
    ...
    grpc::Status SubscribeCustomActionCancellation(grpc::ServerContext* /* context */, const mavsdk::rpc::custom_action::SubscribeCustomActionCancellationRequest* /* request */, grpc::ServerWriter<rpc::custom_action::CustomActionCancellationResponse>* writer) override
    {
        if (_lazy_plugin.maybe_plugin() == nullptr) {
        ...
        _lazy_plugin.maybe_plugin()->subscribe_custom_action_cancellation(
            [this, &writer, &stream_closed_promise, is_finished, subscribe_mutex](const bool custom_action_cancellation) {
        ...
        rpc::custom_action::RespondCustomActionResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin()->respond_custom_action(translateFromRpcActionToExecute(request->action_to_execute()), translateFromRpcCustomActionResult(request->custom_action_result()));
        ...
        rpc::custom_action::CustomActionMetadataResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin()->custom_action_metadata(translateFromRpcActionToExecute(request->action_to_execute()), request->file_path());

        if (response != nullptr) {
            fillResponseWithResult(response, result.first);
            
            response->set_allocated_action_metadata(translateToRpcActionMetadata(result.second).release());
        ...
        rpc::custom_action::ExecuteCustomActionStageResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin()->execute_custom_action_stage(translateFromRpcStage(request->stage()));
        ...
        rpc::custom_action::ExecuteCustomActionGlobalScriptResponse* response) override
    {
        ...
        auto result = _lazy_plugin.maybe_plugin()->execute_custom_action_global_script(request->global_script());
