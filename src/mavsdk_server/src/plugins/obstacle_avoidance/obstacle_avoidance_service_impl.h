...
template<typename ObstacleAvoidance = ObstacleAvoidance, typename LazyPlugin = LazyPlugin<ObstacleAvoidance>>
class ObstacleAvoidanceServiceImpl final : public rpc::obstacle_avoidance::ObstacleAvoidanceService::Service {
public:
    ObstacleAvoidanceServiceImpl(LazyPlugin& lazy_plugin) : _lazy_plugin(lazy_plugin) {}


    template<typename ResponseType>
    void fillResponseWithResult(ResponseType* response, mavsdk::ObstacleAvoidance::Result& result) const
    {
        auto rpc_result = translateToRpcResult(result);

        auto* rpc_obstacle_avoidance_result = new rpc::obstacle_avoidance::ObstacleAvoidanceResult();
    ...
    static rpc::obstacle_avoidance::ObstacleAvoidanceResult::Result translateToRpcResult(const mavsdk::ObstacleAvoidance::Result& result)
    {
        switch (result) {
            default:
            ...
            case mavsdk::ObstacleAvoidance::Result::ConnectionError:
                return rpc::obstacle_avoidance::ObstacleAvoidanceResult_Result_RESULT_CONNECTION_ERROR;
            ...
            case mavsdk::ObstacleAvoidance::Result::CommandDenied:
                return rpc::obstacle_avoidance::ObstacleAvoidanceResult_Result_RESULT_COMMAND_DENIED;
            case mavsdk::ObstacleAvoidance::Result::Timeout:
                return rpc::obstacle_avoidance::ObstacleAvoidanceResult_Result_RESULT_TIMEOUT;
        }
    }

    static mavsdk::ObstacleAvoidance::Result translateFromRpcResult(const rpc::obstacle_avoidance::ObstacleAvoidanceResult::Result result)
    {
        switch (result) {
            default:
                LogErr() << "Unknown result enum value: " << static_cast<int>(result);
