...
// (see https://github.com/mavlink/MAVSDK-Proto/blob/master/protos/obstacle_avoidance_server/obstacle_avoidance_server.proto)
...
template<typename ObstacleAvoidanceServer = ObstacleAvoidanceServer, typename LazyPlugin = LazyPlugin<ObstacleAvoidanceServer>>
class ObstacleAvoidanceServerServiceImpl final : public rpc::obstacle_avoidance_server::ObstacleAvoidanceServerService::Service {
public:
    ...
    static rpc::obstacle_avoidance_server::Control::ControlType translateToRpcControlType(const mavsdk::ObstacleAvoidanceServer::Control::ControlType& control_type)
    {
        switch (control_type) {
            default:
    ...
    static mavsdk::ObstacleAvoidanceServer::Control::ControlType translateFromRpcControlType(const rpc::obstacle_avoidance_server::Control::ControlType control_type)
    {
        switch (control_type) {
            default:
                LogErr() << "Unknown control_type enum value: " << static_cast<int>(control_type);
    ...
    static std::unique_ptr<rpc::obstacle_avoidance_server::Control> translateToRpcControl(const mavsdk::ObstacleAvoidanceServer::Control &control)
    {
    ...
    static mavsdk::ObstacleAvoidanceServer::Control translateFromRpcControl(const rpc::obstacle_avoidance_server::Control& control)
    {
    ...
    grpc::Status SubscribeControl(grpc::ServerContext* /* context */, const mavsdk::rpc::obstacle_avoidance_server::SubscribeControlRequest* /* request */, grpc::ServerWriter<rpc::obstacle_avoidance_server::ControlResponse>* writer) override
    {
        ...
        _lazy_plugin.maybe_plugin()->subscribe_control(
            [this, &writer, &stream_closed_promise, is_finished, subscribe_mutex](const mavsdk::ObstacleAvoidanceServer::Control control) {
